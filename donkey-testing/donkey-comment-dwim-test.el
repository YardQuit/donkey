;;; donkey-comment-dwim-test.el --- Tests for donkey-comment-dwim -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donkey--in-org-src-block-p
;; Selector: (ert "donkey-comment-dwim-in-org-src-block-p")
;; ===========================================================================

(ert-deftest donkey-comment-dwim-in-org-src-block-p-returns-t-in-src-block ()
...
(ert-deftest donkey-comment-dwim-in-org-src-block-p-returns-false-in-paragraph ()
...
(ert-deftest donkey-comment-dwim-in-org-src-block-p-returns-false-in-headline ()
...
(ert-deftest donkey-comment-dwim-in-org-src-block-p-returns-false-if-org-unbound ()
...
(ert-deftest donkey-comment-dwim-in-org-src-block-p-returns-false-if-org-element-nil ()
...
(ert-deftest donkey-comment-dwim-in-org-src-block-p-returns-false-in-non-org-mode ()
...
(ert-deftest donkey-comment-dwim-in-org-src-block-p-all-checks-must-pass ()
...
(ert-deftest donkey-comment-dwim-in-org-src-block-p-non-list-element ()
...
;; ===========================================================================
;; Section: donkey-comment-dwim
;; Selector: (ert "donkey-comment-dwim-")
;;
;;           (ert "donkey-comment-dwim")
...
(ert-deftest donkey-comment-dwim-non-org-without-region ()
...
(ert-deftest donkey-comment-dwim-in-org-src-block-single-line-no-region ()
...
(ert-deftest donkey-comment-dwim-in-org-src-block-line-offset-calculation ()
...
(ert-deftest donkey-comment-dwim-respects-use-region-p ()
...
;;; donkey-comment-dwim-test.el ends here
