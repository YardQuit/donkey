;;; donkey-delete-test.el --- Tests for donkey-delete -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donkey-delete
;; Selector: (ert "donkey-delete")
...
(ert-deftest donkey-delete-no-region-last-char-before-newline ()
...
Expected: donkey-enter-insert not called."
  (let (entered)
    (with-temp-buffer
      (insert "hello\n")
      (goto-char 1)
...
(ert-deftest donkey-delete-region-mark-before-point ()
...
(ert-deftest donkey-delete-rectangle-mode-skips-kill-region ()
...
(ert-deftest donkey-delete-rectangle-mode-skips-delete-char ()
...
;;; donkey-delete-test.el ends here
