;;; donkey-switch-other-buffer-test.el --- Tests for donkey-switch-other-buffer -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donkey-switch-other-buffer
;; Selector: (ert "donkey-switch-other-buffer")
...
(ert-deftest donkey-switch-other-buffer-calls-switch-to-buffer ()
...
(ert-deftest donkey-switch-other-buffer-other-buffer-called-once ()
...
(ert-deftest donkey-switch-other-buffer-switch-to-buffer-called-once ()
...
(ert-deftest donkey-switch-other-buffer-passes-current-buffer-explicitly ()
...
(ert-deftest donkey-switch-other-buffer-switches-to-real-buffer ()
...
(ert-deftest donkey-switch-other-buffer-single-buffer ()
...
(ert-deftest donkey-switch-other-buffer-ignores-prefix-arg ()
...
;;; donkey-switch-other-buffer-test.el ends here
