;;; donkey-yank-pop-test.el --- Tests for donkey-yank-pop -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donkey-yank-pop
;; Selector: (ert "donkey-yank-pop")
...
(ert-deftest donkey-yank-pop-no-region-skips-delete-active-region ()
...
(ert-deftest donkey-yank-pop-no-region-yank-pop-called-once ()
...
(ert-deftest donkey-yank-pop-region-call-order ()
...
(ert-deftest donkey-yank-pop-region-yank-pop-called-once ()
...
(ert-deftest donkey-yank-pop-region-delete-active-region-called-once ()
...
(ert-deftest donkey-yank-pop-empty-buffer-with-region ()
...
(ert-deftest donkey-yank-pop-region-covers-entire-buffer ()
...
(ert-deftest donkey-yank-pop-call-interactively-no-region ()
...
;;; donkey-yank-pop-test.el ends here
