;;; donkey-goto-line-test.el --- Tests for donkey-goto-line -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donkey-goto-line
;; Selector: (ert "donkey-goto-line")
...
(ert-deftest donkey-goto-line-go-to-line-3 ()
...
(ert-deftest donkey-goto-line-from-non-minimum-position ()
...
(ert-deftest donkey-goto-line-line-at-buffer-end ()
...
(ert-deftest donkey-goto-line-input-is-captured ()
...
(ert-deftest donkey-goto-line-single-line-buffer ()
...
(ert-deftest donkey-goto-line-single-line-with-newline ()
...
(ert-deftest donkey-goto-line-goes-to-min-first ()
...
;;; donkey-goto-line-test.el ends here
