;;; donkey-insert-end-of-line-test.el --- Tests for donkey-insert-end-of-line -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donkey-insert-end-of-line
;; Selector: (ert "donkey-insert-end-of-line")
...
Expected: donkey-enter-insert called, point at 12."
  (let (entered)
    (with-temp-buffer
      (insert "hello world\n")
      (goto-char 1)
...
(ert-deftest donkey-insert-end-of-line-from-middle-of-line ()
...
(ert-deftest donkey-insert-end-of-line-from-beginning-of-line ()
...
(ert-deftest donkey-insert-end-of-line-from-third-line ()
...
Expected: point at 6, donkey-enter-insert still called."
  (let (entered)
    (with-temp-buffer
      (insert "hello\n")
      (goto-char 6)
...
(ert-deftest donkey-insert-end-of-line-single-char-buffer ()
...
(ert-deftest donkey-insert-end-of-line-single-char-with-newline ()
...
(ert-deftest donkey-insert-end-of-line-empty-line ()
...
(ert-deftest donkey-insert-end-of-line-empty-line-second ()
...
(ert-deftest donkey-insert-end-of-line-multi-line-last-char ()
...
(ert-deftest donkey-insert-end-of-line-calls-eol-exactly-once ()
...
(ert-deftest donkey-insert-end-of-line-calls-enter-insert-exactly-once ()
...
;;; donkey-insert-end-of-line-test.el ends here
