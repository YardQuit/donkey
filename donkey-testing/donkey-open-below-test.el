;;; donkey-open-below-test.el --- Tests for donkey-open-below -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donkey-open-below
;; Selector: (ert "donkey-open-below")
...
Expected: donkey-enter-insert called, point at 7, buffer has 7 chars."
  (let (entered)
    (with-temp-buffer
      (insert "hello\n")
      (goto-char 1)
...
newline-and-indent, donkey-enter-insert.
...
(ert-deftest donkey-open-below-from-middle-of-line ()
...
(ert-deftest donkey-open-below-from-beginning-of-line ()
...
(ert-deftest donkey-open-below-on-line-without-newline ()
...
(ert-deftest donkey-open-below-on-empty-line ()
...
(ert-deftest donkey-open-below-single-char-buffer ()
...
(ert-deftest donkey-open-below-last-line-with-newline ()
...
(ert-deftest donkey-open-below-calls-newline-and-indent-exactly-once ()
...
(ert-deftest donkey-open-below-calls-enter-insert-exactly-once ()
...
;;; donkey-open-below-test.el ends here
