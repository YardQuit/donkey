;;; donkey-open-above-test.el --- Tests for donkey-open-above -*- lexical-binding: t; -*-
...
;; ===========================================================================
;; Section: donkey-open-above
;; Selector: (ert "donkey-open-above")
...
Expected: donkey-enter-insert called, point at 1, buffer has 7 chars."
  (let (entered)
    (with-temp-buffer
      (insert "hello\n")
      (goto-char 3)
...
(ert-deftest donkey-open-above-from-middle-of-line ()
...
(ert-deftest donkey-open-above-from-beginning-of-line ()
...
(ert-deftest donkey-open-above-from-end-of-line ()
...
(ert-deftest donkey-open-above-on-empty-line ()
...
(ert-deftest donkey-open-above-single-char-buffer ()
...
(ert-deftest donkey-open-above-last-line-with-newline ()
...
(ert-deftest donkey-open-above-calls-newline-and-indent-exactly-once ()
...
(ert-deftest donkey-open-above-calls-enter-insert-exactly-once ()
...
;;; donkey-open-above-test.el ends here
