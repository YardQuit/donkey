...
- [[#moving][Moving]]
- [[#entering-insert][Entering INSERT state]]
- [[#editing][Editing]]
- [[#selecting][Selecting]] — objects, rectangles, banks, the mark run
- [[#wrapping][Wrapping a selection in a pair]]
- [[#enter-key][The Enter key]]
- [[#search-replace][Search and replace]]
- [[#digraphs][Typing characters your keyboard lacks]]
- [[#input-methods][Other languages]]
- [[#suppressed-keys][Suppressed keys]]

*Making it yours*

- [[#making-it-yours][Your own keys]] — one key, the leader, giving a key back
- [[#key-not-doing][If a key is not doing what you want]]
- [[#stepping-aside][Modes where DONKEY steps aside]]
- [[#cursor][The cursor]]
- [[#clipboard][The clipboard]]
- [[#enter-rules][Configuring the Enter key]]
- [[#own-pairs][Choosing your own pairs]]
- [[#mode-insert-commands][Keys a major mode types with]]
- [[#why-excluded][Why those six modes ship excluded]] — the reasoning, for readers who want it
- [[#digraph-chart][The digraph chart]]
- [[#complete-config][A complete configuration]]
...
the package's key is waiting for you in INSERT state. [[#key-not-doing][If a Key Is Not
...
see [[#stepping-aside][Modes Where DONKEY Steps Aside]].
...
=V= — see [[#long-lines][Long lines]] above — also serves as a line-wise selection
...
your own is [[#own-pairs][one line]], and what =m i= can select, a key can wrap.
...
leave; see [[#run-follows][A mark run follows you between buffers]].
...
[[#digraphs][Typing characters your keyboard lacks]] — and rectangles can be wrapped
line by line.
...
see [[#enter-rules][Enter Rules]] to change or extend that.
...
not on this list because it wraps — see [[#wrapping][Wrapping a selection]].
...
See [[#stepping-aside][Modes Where DONKEY Steps Aside]], just below. One line, and the
...
reading stopped. [[#why-excluded][Why Those Six Modes Ship Excluded]]
...
[[#stepping-aside][Modes Where DONKEY Steps Aside]] shows, and please
...
[[#stepping-aside][What you give up by excluding magit and dired]].

* The Digraph Chart
:PROPERTIES:
:CUSTOM_ID: digraph-chart
:END:
