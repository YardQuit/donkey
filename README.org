...
count adds that many. A line shorter than the column gets its cursor
at its end. The other cursors are drawn in the real cursor's shape,
...
| a pair                                 | wrap, or put the pair in               |
