...
#+begin_src emacs-lisp
  ...
  (use-package donkey
    ...
    ;; and l mean there; j and k are never written down.  Forty ship --
    ;; see the chapter above for the whole table.
    ;;
    ;; CONS rather than a literal list: setopt with a list of your own
    ;; REPLACES the table and takes the other thirty-nine with it.  The
