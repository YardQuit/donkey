...
somewhere to go. Thirty-nine sections ship; twenty-four of them give
=h= or =l= a meaning:
...
Eighteen sections name the =prose= package instead of pairs:
...
=so-long-mode=, =compilation-mode= and =emacs-lisp-compilation-mode=,
...
| =donkey-support-modes=             | 39 sections, see above           | what =h= and =l= do in a support mode |
